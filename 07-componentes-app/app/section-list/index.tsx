    ...
    <ThemedView margin>
      <ThemedCard>
        ...
        renderSectionHeader={({section}) => (
          <ThemedText type='h1' className='bg-light-background dark:bg-dark-background p-2 rounded'>
            {section.title}
          </ThemedText>
        )}
        stickySectionHeadersEnabled
        ListFooterComponent={() => (
          <ThemedText type='h1' className='font-bold bg-light-background dark:bg-dark-background p-2 m-10 rounded'>
